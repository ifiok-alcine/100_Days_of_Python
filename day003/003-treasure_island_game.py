...
if choice1 == "left":
    ...
    if choice2 == "wait":
        ...
        if choice3 == "red":
            print("You have found the lost treasure. You Win!")
        else:
            print("The treasure is not at this door. You lose.")
    else:
        print("you are attacked by an angry shark. Game over")

else:
    print("This path leads to a dead end. You lose")
